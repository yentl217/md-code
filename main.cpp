...
//***************************************************************************//
	...
	//Start simulation by calculating the initial forces - needed for some (e.g. Verlet) integration methods, and for debugging.
	...
	for (int i = 0; i < settings.get_num_steps(); i++) 
	{
		...
		{
			cout << "Current Temperature is :" << actual_temp << "K" << endl;
		}
	}
